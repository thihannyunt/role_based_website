                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Most View Ideas</h1>                        
                    </div>
                        ...
                        <?php 
                            ...
                            for ($i=1; $i <= $count ; $i++) { 
                                ...
                                if($i == $page){
                                    ...
                                    echo "<li><a class='active_link' href='./idea.php?source=most_view_ideas?page={$i}'>{$i}</a></li>";

                                }

                                else{

                                    echo "<li><a href='idea.php?source=most_view_ideas?page={$i}'>{$i}</a></li>";
